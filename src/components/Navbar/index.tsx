        ...
        <div className="container-md d-flex justify-content-between align-items-center">
          ...
          <div style={{ width: '33%' }} className="d-flex justify-content-center">
            <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
              <li className="nav-item item-pad"><a className="nav-link desy-link" href="/eligibility">Eligibility</a></li>
              <li className="nav-item item-pad"><a className="nav-link desy-link" href="/courses">Courses</a></li>
              <li className="nav-item item-pad"><a className="nav-link desy-link" href="/founders">Founders</a></li>
              <li className="nav-item item-pad"><a className="nav-link desy-link" href="/contact">Contact</a></li>
            </ul>
          </div>
