            ...
            <div className="row">
                <div className="col guest-col">
                    <div className='col-left'>
                        <h1 className='guest-heading'>Contact Us</h1>
                        <h2 className="guest-subheading">Find us here</h2>
                        ...
                        <h2 className='guest-subheading'>Mobile No</h2>
                        <div className='sub-block'>
                            <p>+91-9541587692</p>
                            <p>+91-9654286574</p>
                        </div>
                        <h2 className='guest-subheading'>Social</h2>
                        <i className="sub-block guest-bi bi bi-linkedin"></i>
                        <i className="sub-block guest-bi bi bi-twitter"></i>
                        <i className="sub-block guest-bi bi bi-facebook"></i>
                    </div>
                </div>
                <div className="col guest-col">
                    <div className='col-right'>
                        <form>
                            <h2 className="guest-subheading">Any Doubts?</h2>
                            <br />
                            ...
                            <button type="submit" className="guest-btn btn btn-success"> Submit </button>
                        </form>
                    </div>
                </div>
            </div>
